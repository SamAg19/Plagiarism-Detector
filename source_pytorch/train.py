...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input-features', type=int, default=3, metavar='N',
                        help='size of the input features (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='N',
                        help='size of the hidden dimension (default: 10)')
    parser.add_argument('--output-dim', type=float, default=1, metavar='N',
